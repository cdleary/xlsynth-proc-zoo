...
SINGLE_DSLX="${ROOT_DIR}/examples/ram_fetch_relu/fetch_relu_single_cold_steady_drain.x"
SINGLE_IR="${BUILD_DIR}/fetch_relu_single_cold_steady_drain.ir"
SINGLE_SV="${BUILD_DIR}/fetch_relu_single_cold_steady_drain.sv"
SIM_OUT="${BUILD_DIR}/fetch_relu_single_cold_steady_drain_tb.out"
VCD_PATH="${VCD_PATH:-${BUILD_DIR}/fetch_relu_single_cold_steady_drain_tb.vcd}"
...
echo "== Codegen: single cold/steady/drain proc"
...
iverilog -g2012 \
  ...
  "${ROOT_DIR}/tb/ram_fetch_relu/fetch_relu_single_cold_steady_drain_tb.sv" \
  "${SINGLE_SV}"
