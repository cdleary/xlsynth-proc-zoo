...
SINGLE_DSLX="${ROOT_DIR}/examples/ram_fetch_relu/fetch_relu_single_dual_token.x"
SINGLE_IR="${BUILD_DIR}/fetch_relu_single_dual_token.ir"
SINGLE_SV="${BUILD_DIR}/fetch_relu_single_dual_token.sv"
SIM_OUT="${BUILD_DIR}/fetch_relu_single_dual_token_tb.out"
VCD_PATH="${VCD_PATH:-${BUILD_DIR}/fetch_relu_single_dual_token_tb.vcd}"
...
iverilog -g2012 \
  ...
  "${ROOT_DIR}/tb/ram_fetch_relu/fetch_relu_single_dual_token_tb.sv" \
  "${SINGLE_SV}"
